...
class QuadcopterEnv(BaseRLAviary):
    ...
    def __init__(self, task="circle", custom_target=None, render_mode="none",max_steps=8000):
        ...
        `task` is a string: "circle", "figure8", "four_points", or "goto".
        """
        # Fixed task for this env
        self.task = task
        ...
        # obs = pos(3) + vel(3) + rpy(3) + ang_vel(3) + rel_waypoint(3) = 15
    ...
    def step(self, action):
        ...
        # Mix policy action + waypoint direction
        #  - policy: 0.5 * delta
        #  - waypoint pull: 0.2 * rel
        target = pos + 0.5 * delta + 0.2 * rel

        # smooth altitude toward waypoint z
        target[2] = 0.8 * target[2] + 0.082 * wp[2]
    ...
    def _computeReward(self):
        ...
        # 5) Direction alignment (move *toward* waypoint)
    ...
    def _computeTerminated(self):
        ...
        # done when last waypoint reached
